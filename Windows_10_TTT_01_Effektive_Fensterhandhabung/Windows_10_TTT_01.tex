...
(Windows-Snapping). Ich zeige die entsprechenden Schritte auch in
Teil~01 meiner \emph{Tipps, Tricks und Techniken zu Windows
10}-Videoserie auf \texttt{YouTube}.
%
\begin{center}
